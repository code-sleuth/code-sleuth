...
- [meshery/meshery](https://github.com/meshery/meshery) ([v0.7.110](https://github.com/meshery/meshery/releases/tag/v0.7.110), today) - Meshery, the cloud native manager
...
- [launchbadge/sqlx](https://github.com/launchbadge/sqlx) - 🧰 The Rust SQL Toolkit. An async, pure Rust SQL crate featuring compile-time checked queries without a DSL. Supports PostgreSQL, MySQL, and SQLite. (4 weeks ago)
