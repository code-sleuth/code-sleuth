...
- [meshery/meshery](https://github.com/meshery/meshery) ([v0.7.127](https://github.com/meshery/meshery/releases/tag/v0.7.127), 1 day ago) - Meshery, the cloud native manager
...
- [pepperoni21/ollama-rs](https://github.com/pepperoni21/ollama-rs) - A Rust library allowing to interact with the Ollama API. (2 days ago)
- [meshery/meshery](https://github.com/meshery/meshery) - Meshery, the cloud native manager (2 days ago)
- [lichess-org/fishnet](https://github.com/lichess-org/fishnet) - Distributed Stockfish analysis for lichess.org (6 days ago)
