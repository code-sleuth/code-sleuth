...
- [meshery/meshery](https://github.com/meshery/meshery) ([v0.7.102](https://github.com/meshery/meshery/releases/tag/v0.7.102), today) - Meshery, the cloud native manager
...
- [feat: switch email client and use secrecy wrapper types for secret management](https://github.com/code-sleuth/outh/pull/22) on [code-sleuth/outh](https://github.com/code-sleuth/outh) (4 days ago)
...
- [prometheus/prometheus](https://github.com/prometheus/prometheus) - The Prometheus monitoring system and time series database. (4 weeks ago)
